# -*- coding: utf-8 -*-
"""
Created on Thu May  9 15:10:47 2024
...
# Transformer model reference https://github.com/lucidrains/vit-pytorch/blob/main/vit_pytorch/simple_vit.py
...
parentDir = "_Path_to_the_PKL_files_" + "/pkl files/" # For UI-PRMD Vicon data

current_exercise = 'm01' # Exercise number 




X_train_path = parentDir + current_exercise + '/' + current_exercise + '_train_data.pkl' 
X_train = joblib.load(X_train_path)

X_test_path = parentDir + current_exercise + '/' + current_exercise + '_test_data.pkl' 
X_test = joblib.load(X_test_path)


y_train_path = parentDir + current_exercise + '/' + current_exercise + '_train_score.pkl' 
y_train = joblib.load(y_train_path)

y_test_path = parentDir + current_exercise + '/' + current_exercise + '_test_score.pkl' 
