...
for i=1:nSubjects-1
    for j=1:nEpisodes-1
        eval(['Train1_ang_cor{',int2str(i),',',int2str(j),'} = csvread(''Segmented Movements\Vicon\Positions\m01_s0',int2str(i),'_e0',int2str(j),'_positions.txt'');']);
    end
end

for i=1:nSubjects-1
    for j=nEpisodes
        eval(['Train1_ang_cor{',int2str(i),',',int2str(j),'} = csvread(''Segmented Movements\Vicon\Positions/m01_s0',int2str(i),'_e',int2str(j),'_positions.txt'');']);
    end
end

for i=nSubjects
    for j=1:nEpisodes-1
        eval(['Train1_ang_cor{',int2str(i),',',int2str(j),'} = csvread(''Segmented Movements\Vicon\Positions\m01_s',int2str(i),'_e0',int2str(j),'_positions.txt'');']);
    end
end

for i=nSubjects
    for j=nEpisodes
        eval(['Train1_ang_cor{',int2str(i),',',int2str(j),'} = csvread(''Segmented Movements\Vicon\Positions/m01_s',int2str(i),'_e',int2str(j),'_positions.txt'');']);
    end
end
...
for i=1:nSubjects-1
    for j=1:nEpisodes-1
        eval(['Test1_ang_inc{',int2str(i),',',int2str(j),'} = csvread(''Incorrect Segmented Movements\Vicon\Positions/m01_s0',int2str(i),'_e0',int2str(j),'_positions_inc.txt'');']);
    end
end

for i=1:nSubjects-1
    for j=nEpisodes
        eval(['Test1_ang_inc{',int2str(i),',',int2str(j),'} = csvread(''Incorrect Segmented Movements\Vicon\Positions\m01_s0',int2str(i),'_e',int2str(j),'_positions_inc.txt'');']);
    end
end

for i=nSubjects
    for j=1:nEpisodes-1
        eval(['Test1_ang_inc{',int2str(i),',',int2str(j),'} = csvread(''Incorrect Segmented Movements\Vicon\Positions/m01_s',int2str(i),'_e0',int2str(j),'_positions_inc.txt'');']);
    end
end

for i=nSubjects
    for j=nEpisodes
        eval(['Test1_ang_inc{',int2str(i),',',int2str(j),'} = csvread(''Incorrect Segmented Movements\Vicon\Positions/m01_s',int2str(i),'_e',int2str(j),'_positions_inc.txt'');']);
    end
end
